CREATE USER 'ci-baseplate'@'localhost' IDENTIFIED BY  'ci-baseplate';

GRANT USAGE ON * . * TO  'ci-baseplate'@'localhost' IDENTIFIED BY  'ci-baseplate' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;

CREATE DATABASE IF NOT EXISTS  `ci-baseplate` ;

GRANT ALL PRIVILEGES ON  `ci-baseplate` . * TO  'ci-baseplate'@'localhost';
