...
class MY_Cart extends CI_Cart
{
    ...
    /*
     * Allows the product title to include any charecters
     */
    ...
    function _insert($items = array())
    {
        ...
        if (isset($items['options']) AND count($items['options']) > 0)
        {
           ...
           //Allow multiple implosion
            $to_implode = $items['options'];
            $rowid = md5($items['id'] . $this->multi_implode('', $to_implode));
        }
        else
        {
...
//
       ...
       /*
        * Allows the implosion of multiple dimensional arrays
        *
        * @param string what the array should be joined with
